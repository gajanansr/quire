 ...
 *
 * A share card is the most public thing Quire makes, and its whole content is a
 ...
 *
 * The measure is WCAG's contrast ratio, the same one `QuireThemeTest` holds the app's
