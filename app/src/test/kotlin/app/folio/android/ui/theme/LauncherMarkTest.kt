 ...
 *
 * An adaptive icon is masked by the launcher, not by Folio: a circle here, a squircle
...
class LauncherMarkTest {
    ...
    fun `the mark is two leaves with a fold between them`() {
        // The shape is the point: a folio is one sheet folded once. Two paths that
