 ...
 *
 * Folio's minSdk is 26 and there is no device here to try it on, so this is the
...
class RemotableCallTest {
    ...
    fun `the list is the list the widgets actually use`() {
        ...
        val source = java.io.File("src/main/kotlin/app/folio/android/widget/WidgetViews.kt")
