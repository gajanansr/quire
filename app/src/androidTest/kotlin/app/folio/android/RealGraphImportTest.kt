 ...
 *
 * Two purposes. It proves `FolioGraph` wires up correctly outside a test harness,
...
class RealGraphImportTest {
    ...
    fun importsRealBooksIntoTheShippedGraph() = runBlocking {
        val folioApp = InstrumentationRegistry.getInstrumentation()
            .targetContext.applicationContext as FolioApp
        val graph = folioApp.graph
