 ...
 *
 * The whole of Quire's widget theming, and the one technique that works from API 26:
...
fun habitViews(
    ...
    views.setOnClickPendingIntent(
        ...
        QuireWidgets.pendingOpen(context, QuireWidget.HABIT),
    )
    return views
}
...
fun statsViews(
    ...
    views.setOnClickPendingIntent(
        ...
        QuireWidgets.pendingOpen(context, QuireWidget.STATS),
    )
    return views
}
