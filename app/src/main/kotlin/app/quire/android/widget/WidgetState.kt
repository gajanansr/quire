 ...
 * `ReaderState` and `QuireBack` already use, applied where it matters most.
 */
...
data class WidgetSnapshot(
     ...
     */
    val theme: QuireThemeName = QuireThemeName.PAPER,
) {
    /**
 ...
 *
 * The headline is the number, the way [app.quire.android.ui.habit.StreakScreen]
