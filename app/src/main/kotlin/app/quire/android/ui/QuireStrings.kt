...
object QuireStrings {
    ...
    // The leading "+" is drawn by QuireIcons.Add now, not spelled in the copy.
    ...
    const val SUPPORTED_EXPLAINER = "Quire supports EPUB, PDF, and TXT files."
    ...
    const val SCANNED_EXPLAINER =
        "Its pages are images, not text, so Quire shows them as they were printed. " +
    ...
    // and what the reader is asked and shown in Quire itself.
    ...
    // they have already read is a day Quire says nothing.
     ...
     * the reader has reminders switched on in Quire and Android will not deliver
     * them. A row reading "On" there is the only thing standing between them and
     * quietly wondering why Quire stopped reminding them.
     */
