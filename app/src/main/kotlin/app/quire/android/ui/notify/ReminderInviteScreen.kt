package app.quire.android.ui.notify
...
/**
 * The one time Quire asks about notifications.
 *
...
fun ReminderInviteScreen(
    ...
    Column(
        ...
        Text(
            QuireStrings.REMINDER_INVITE_TITLE,
            color = colors.ink,
            style = MaterialTheme.typography.displayLarge,
        )
        Spacer(Modifier.height(18.dp))
        Text(
            QuireStrings.REMINDER_INVITE_BODY,
            color = colors.muted,
        ...
        PrimaryButton(QuireStrings.REMINDER_INVITE_YES, onAccept)
        ...
        Box(
            ...
            Text(
                QuireStrings.REMINDER_INVITE_NO,
                color = colors.muted,
