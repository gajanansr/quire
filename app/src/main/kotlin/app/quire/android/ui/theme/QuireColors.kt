 ...
 */
enum class QuireThemeName { PAPER, SEPIA, EINK, NIGHT, BLACK }
...
object QuirePalettes {
    ...
    fun of(theme: QuireThemeName): QuireColors = when (theme) {
        QuireThemeName.PAPER -> Paper
        QuireThemeName.SEPIA -> Sepia
        QuireThemeName.EINK -> Eink
        QuireThemeName.NIGHT -> Night
        QuireThemeName.BLACK -> Black
    }
}
 ...
 */
fun QuireThemeName.label(): String = when (this) {
    QuireThemeName.PAPER -> "Paper"
    QuireThemeName.SEPIA -> "Sepia"
    QuireThemeName.EINK -> "E-ink"
    QuireThemeName.NIGHT -> "Night"
    QuireThemeName.BLACK -> "Black"
}
 ...
 */
fun themeNamed(stored: String?): QuireThemeName = when (stored) {
    null -> QuireThemeName.PAPER
    "LIGHT" -> QuireThemeName.PAPER
    "PALE" -> QuireThemeName.SEPIA
    "DARK" -> QuireThemeName.NIGHT
    else -> QuireThemeName.entries.firstOrNull { it.name == stored } ?: QuireThemeName.PAPER
}
