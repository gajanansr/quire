 ...
 * assertable, and [app.quire.android.notify.ReminderWorker] is then thin enough to
 * be read at a glance.
 */

/** The two things Quire ever says, and the only two. */
...
object Reminders {
     ...
     * Quire that talks about clock time.
     *
