...
/**
 * The notification Quire posts, and nothing else.
 *
...
object QuireNotifier {
     ...
     * Quire for a week comes back to one notification rather than seven. Seven
    ...
    private fun ensureChannel(manager: NotificationManager) {
        ...
        manager.createNotificationChannel(
            NotificationChannel(
                ...
                description = QuireStrings.REMINDER_CHANNEL_EXPLAINER
                setShowBadge(false)
            }
        )
    }
    ...
    /**
     * Opens Quire where the reader left it.
     *
     * No action buttons. "Snooze" and "Dismiss" are both ways of asking the reader
     * to manage Quire's feelings; the two things they might want are to read, or to
 ...
 * this check Quire would carry on "reminding" someone who had switched it off and
...
object NotificationAccess {
    ...
    fun granted(context: Context): Boolean {
        ...
        return granted(
            ...
            // and [QuireNotifier.post] creates it on the way past.
