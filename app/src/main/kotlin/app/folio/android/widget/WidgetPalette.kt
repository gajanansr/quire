...
data class WidgetPalette(
     ...
     * day, the track under the progress fill, an unlit flame. In Folio "not yet" is
 ...
 * `setColorFilter`. Nothing here is a literal: the tokens are `FolioPalettes`', so a
 ...
 */
fun widgetPalette(theme: FolioThemeName): WidgetPalette {
