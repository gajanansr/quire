...
/**
 * Every address Folio can send a reader to.
 *
 ...
 *
 * **Most of these are deliberately blank.** Folio has no website and no hosted
...
object FolioLinks {
     ...
     *
     * The subject matters more than it looks: a mail arriving with "Folio" in it can
...
/**
 * What Folio says its version is.
 *
