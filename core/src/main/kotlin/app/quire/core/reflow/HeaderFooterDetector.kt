 ...
 * least [QuireConstants.HEADER_RECURRENCE] of pages, and the document has enough
...
class HeaderFooterDetector {
    ...
    fun strip(pages: List<List<Line>>, pageHeights: List<Float>): StripResult {
        ...
        fun topBandOf(p: Int) = pageHeights[p] * (1f - QuireConstants.MARGIN_BAND)
        fun bottomBandOf(p: Int) = pageHeights[p] * QuireConstants.MARGIN_BAND
        ...
        val threshold = pages.size * QuireConstants.HEADER_RECURRENCE
