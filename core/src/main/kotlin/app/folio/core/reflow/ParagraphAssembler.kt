 ...
 *
 * Headings are identified here rather than in [app.folio.core.structure.ChapterDetector]
...
class ParagraphAssembler {
    ...
    private fun breaksParagraph(
        ...
        if (leading > 0f && gap > leading * FolioConstants.PARAGRAPH_GAP_FACTOR) return true
    ...
    private fun isHeading(
        ...
        val isolated = leading <= 0f ||
            gapBefore > leading * FolioConstants.PARAGRAPH_GAP_FACTOR ||
