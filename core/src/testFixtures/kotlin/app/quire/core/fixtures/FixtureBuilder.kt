...
object Fixtures {
     ...
     * instrumented tests override it via `quire.fixtures.dir` because an app on
     ...
     */
    private const val FIXTURE_VERSION = 6

    private val root: File by lazy {
        val override = System.getProperty("quire.fixtures.dir")
    ...
    private fun opf(withNav: Boolean, withCover: Boolean = false) = """
        ...
        <package xmlns="http://www.idpf.org/2007/opf" version="3.0" unique-identifier="uid">
          <metadata xmlns:dc="http://purl.org/dc/elements/1.1/">
            <dc:identifier id="uid">urn:uuid:quire-test-0001</dc:identifier>
            <dc:title>A History of Quiet Things</dc:title>
            <dc:creator>Ada Marlowe</dc:creator>
            <dc:language>en</dc:language>
            <dc:publisher>Quire Test Press</dc:publisher>
